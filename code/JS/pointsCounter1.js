...
function chooseVideo() {
    if (data_fake_numeric == 0 && counter == 2) {
        frwdButton.setAttribute('href', '../pages/video__final_2p_fake_f1.html');
    }
    else if (counter == 0) {
        frwdButton.setAttribute('href', '../pages/video__final_0p_f1.html');
    } else if (counter == 1) {
