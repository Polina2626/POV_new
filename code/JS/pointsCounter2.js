...
function chooseVideo() {
    if (counter == 0) {
        frwdButton.setAttribute('href', '../pages/video__final_0p_f2.html');
    } else if (counter == 1) {
        frwdButton.setAttribute('href', '../pages/video__final_1p_f2.html');
    } else if (counter == 2) {
        frwdButton.setAttribute('href', '../pages/video__final_2p_f2.html');
    } else if (counter == 3) {
        frwdButton.setAttribute('href', '../pages/video__final_3p_f2.html');
    }
